 ...
 */
public class ReceiveMoney implements Parcelable{
    ...
    public ReceiveMoney(int receiveMoneyID, double amount, Date receiveDate, String description, Account account, ReceiveItem receiveItem, Lender lender, Borrower borrower, Event event) {
    ...
    protected ReceiveMoney(Parcel in) {
    ...
    public static final Creator<ReceiveMoney> CREATOR = new Creator<ReceiveMoney>() {
        @Override
        public ReceiveMoney createFromParcel(Parcel in) {
            return new ReceiveMoney(in);
        }

        @Override
        public ReceiveMoney[] newArray(int size) {
            return new ReceiveMoney[size];
        }
    };
